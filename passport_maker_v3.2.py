...
# rembg থেকে new_session ইমপোর্ট করা হলো মডেল সিলেক্ট করার জন্য
...
class BgRemoverThread(QThread):
    ...
    def run(self):
        try:
            ...
            # সমস্যা সমাধানের জন্য পরিবর্তন:
            # ১. মানুষের জন্য স্পেশাল মডেল 'u2net_human_seg' ব্যবহার করা হচ্ছে।
            # ২. Alpha Matting অন করা হয়েছে যাতে চুলের ডিটেইলস স্মুথ আসে।
...
class PassportMakerApp(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("স্মার্ট পাসপোর্ট ফটো স্টুডিও V2 (High Quality)")
